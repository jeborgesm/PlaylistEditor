namespace AdvancedWebBrowser
{
    ...
    partial class InternetOption
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "Number of urls in address bar";
			// 
			// num
			// 
			...
			this.btnOK.Location = new System.Drawing.Point(115, 292);
			...
			this.groupBox1.Controls.Add(this.btnUseCurrent);
