                    ...
                    Parallel.ForEach(Directory.GetFiles(d), po, f =>
                    {
                        ...
                        if (ScrapeResponse != "")
                        {
                            ...
                            if (game.name != "")
                            {
                                ...
                                string imagepath = ScrapeHandler.getImage("http://www.mamedb.com/titles/" + Path.GetFileNameWithoutExtension(game.path) + ".png", Path.GetFileNameWithoutExtension(game.path));
                                if (imagepath != "")
                                {
